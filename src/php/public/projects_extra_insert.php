...
if(project.length == 0){
    window.location= "project_back.php";
}

var clientID=$('#clientID').val();

if(clientID.length == 0){
    window.location= "project_back1.php";
}
...
if (n > 0){
    ...
    window.location= "project_back2.php";
}
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#create_internal').click(function(){
            var projectID=$('#projectID').val();
var project=$('#project').val();
var clientID=$('#clientID').val();
var kickoff=$('#kickoff').val();
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#create_physical').click(function(){
            var projectID=$('#projectID').val();
var project=$('#project').val();
var clientID=$('#clientID').val();
var kickoff=$('#kickoff').val();
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#create_wire').click(function(){ alert("hi");
            var projectID=$('#projectID').val();
